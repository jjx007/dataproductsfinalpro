...
shinyUI(
    navbarPage("MTcars App",
               ...
               tabPanel("Dataset Info in detail",
               ...
               tabPanel("Check out the code",
                        a("https://github.com/jjx007/dataproductsfinalpro"),
                        hr(),
                        h4("Search for jjx007/dataproductsfinalpro repo at github.com"),
